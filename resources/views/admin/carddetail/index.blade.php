                    ...
                    <table class="table table-dark">
                        <thead>
                            <tr>
                                ...
                                <th width="30%">カード名</th>
                                <th width="30%">読み</th>
                                <th width="30%">カードの種類</th>
                                <th width="30%">カード画像</th>
                                <th width="30%">カードテキスト</th>
                        ...
                        <tbody>
                            @foreach($posts as $carddetail)
                                <tr>
                                    <th>{{ $carddetail->id }}</th>
                                    <td>{{ str_limit($carddetail->card_name, 100) }}</td>
                                    <td>{{ str_limit($carddetail->ruby, 100) }}</td>
                                    <td>{{ str_limit($carddetail->card_class, 100) }}</td>
                                    <td>{{ str_limit($carddetail->image_path, 100) }}</td>
