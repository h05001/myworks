...
Route::group(['prefix' => 'admin'], function() {
    ...
    Route::post('tournamentDeckCard/import', 'Admin\TournamentDeckCardController@import');
    Route::get('tournamentDeckCard/ranking', 'Admin\TournamentDeckCardController@ranking');
